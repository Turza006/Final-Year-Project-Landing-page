<template>
  <div>
    <div v-if="!$vuetify.breakpoint.mobile" id="packages" class="pt-8 px-10">
      <div class="text-center">
        <h3 class="display-3 primary--text">
          Packages
        </h3>
      ...
      <v-row class="px-8 pt-6">
        <v-col v-for="(item, index) in allPackageByCategory" :key="index" class="pa-3">
          <v-card class="py-8 px-4" style="border-radius: 30px" outlined>
            <div class="primary--text text-center">
              ...
              <p class="mt-5">
                ...
                ever-present,
                on home screens, docks, and taskbars.
              </p>
              <span class="font-weight-bold" style="font-size: 30px">{{ item.packagePrice }}<span
                style="padding-left: 1px"
              >$</span></span><span style="font-size: 12px"> per month</span>
            </div>

            <div class="my-5 text-center">
              <v-btn class="primary white--text" rounded outlined @click.stop="cartItem(item)">
                Add to Cart
              </v-btn>
            </div>
            ...
            <div>
              <v-simple-table
                style="border: 1px solid #eee; border-radius: 15px"
              ...
              >
                <template #default>
                  ...
                  <tbody>
                    <tr
                      v-for="(service, i) in item.serviceCovered"
                      :key="i"
                    >
          ...
          <v-card class="py-8 px-4" style="border-radius: 30px" outlined>
            ...
            <div class="my-5 text-center">
              <v-btn
                ...
                :disabled="customPackageData.serviceCovered.length < 3"
                rounded
                @click.stop="customCartItem()"
              >
                Add to cart
              </v-btn>
            </div>
            <div>
              ...
              >
                <template #default>
                  ...
                  <tbody>
                    <tr
                      v-for="(service, index) in allService.Services"
                      :key="index"
                    >
                      <td>{{ service.serviceName }}</td>
                      <td>
