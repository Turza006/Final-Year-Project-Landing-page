<template>
  <div>
    <div v-if="!$vuetify.breakpoint.mobile">
      <h1 id="pricing" class="text-center display-3 primary--text">
        Pricing
      </h1>
      <p style="font-size: 18px" class="text-center grey--text mt-3">
    ...
    <div v-else>
      ...
      <p style="font-size: 16px" class="text-center grey--text px-4 mt-3">
        Lorem Ipsum is simply dummy text of the printing and
        typesetting
        industry.
      </p>
